...
# parser.add_argument('-dr', '--data-root', default=r'/data/mimic_cxr/PA/7_1_2', type=str, help="Your Data Set Root")
parser.add_argument('-cd', '--cuda_devices', default=[4], nargs='+', type=int, help="Cuda device ids for running")
...
parser.add_argument('--save-dir', default=r'checkpoint_2x2_demo', type=str, help="The save directory for selected checkpoints of model")
